SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_datetime, tag: 'div', class: 'mb-3 row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :pattern
    b.optional :readonly
    ...
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-4' do |ba|
      ba.use :input, class: 'form-control', type: 'datetime-local', autocomplete: 'off', error_class: 'is-invalid', valid_class: 'is-valid'
