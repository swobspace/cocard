...
RSpec.describe ConnectorsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #connector_sds" do
      expect(get: "/connectors/1/connector_sds").to route_to("connectors#connector_sds", id: "1")
    end

    it "routes to #check" do
      expect(post: "/connectors/1/check").to route_to("connectors#check", id: "1")
    end
