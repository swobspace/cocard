...
Der Health-Check aktualisiert gleichzeitig statistische Daten in Cocard wie die Anzahl der Steckzyklen der einzelnen Slots. Weitere Parameter des Kartenterminals können über den xref:admin/duck-terminal.adoc[IP-Check] abgefragt werden.
