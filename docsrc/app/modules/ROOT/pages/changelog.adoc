...
* Speicherung der `connector.sds` als XML-Format zusätzlich zum Hash
* Anzeige von `connector.sds` (XML-Format)
* Security Updates
* Internals:
** Migration zu datatables 3.0, jquery-Abhängigkeiten entfernt
** Refactoring: ImmutableStruct durch ruby class Data ersetzt

== 1.0.5 - 2026-07-18

* Unterstützung für das Cherry ST-1506 (nur SMC-B Remote-PIN-Verifizierung)
* Bugfixes und Security Updates

== 1.0.4 - 2026-06-06

* VZD-Suche: Konfiguration zu verwendenden Konnektors
* Dokumentation zur VZD-Suche
* Rolle Reader: Recht für Notizen erstellen entfernt

== 1.0.3 - 2026-05-24

* VZD-Suche. Verwendet wird derzeit der erste Konnektor, der OK ist mit dem Zertifikat für das Clientsystem "cocard".

== 1.0.2 - 2026-05-17

* Undelete/final Delete für SoftDeleted Objekte
* Bugfixes und Security Updates

== 1.0.1 - 26-03-28

* Bugfixes und Security Updates for Rails


== 1.0.0 - 2026-03-01

* Bugfixes
* SoftDeleted Objekte (Karte, Kartenterminal, Konnektor) werden in die globale Suche mit eingeschlossen und im Suchergebnis farblich gekennzeichnet
* Berechtigungen Kartenzertifikate lesen für CardManager
* Manuelle Anlage von Kartenterminal-Slots für die Zuordnung von Karten zu Kartenterminals, die Cocard nicht selbst erreichen kann.

== 0.9.9 - 2026-01-25

* Überarbeitung der Dokumentation
* Manuelles Einlesen aller Zertifikate auf einer SMC-B/einem HBA; entweder nur die Karte oder alle Karten in einem Kartenterminal
* Support für Konnektor-Zertifikate mit brainpoolP256r1
* Bearbeiten von Tags nun möglich.
* Anzeige der TLS-Verbindungsparameter Kartenterminal-Konnektor beim IP-Check des Kartenterminals
* RISE TIClient: Trennen und Verbinden der TLS-Verbindung eines gepairten Kartenterminals
* RISE TIClient: Dokumentation überarbeitet

== 0.9.8 - 2026-01-04

* Upgrade Framework auf Rails 8.1 / Ruby 3.4
* keine inhaltlichen Änderungen

== 0.9.7 - 2026-01-01

* diverse Bugfixes im Zusammenhang mit SoftDelete.
* Notizen/Acknowledges als Mail versenden. Dabei werden Informationen zum Objekt (Konnektor, Kartenterminal, Karte) automatisch ergänzt.
* ARP-Abgleich für Kartenterminals
* Überarbeitung der Dokumentation

== 0.9.6 - 2025-12-20

* RISE TIClient: Kartenterminal dem Konnektor hinzufügen (wenn der Konnektor trotz vorhandenem KTProxy das Kartenterminal nicht sieht)
* OutdatedJob: setzt Karten und Kartenterminals auf Status NOTHING, wenn länger als ein Tag kein Update mehr erfolgt ist. Das verhindert, dass Objekte, die beim letzten Check als OK erkannt wurden im Zustand OK verbleiben, auch wenn wochenlang gar keine Informationen zu dem Objekt ermittelt werden konnten.
* SoftDelete für Konnektoren und Kartenterminals (und weiterhin für Karten)
* Health-Check bei Kartenterminals prüft nun die Verfügbarkeit einer gültigen SMC-KT
* Notizen bei Konnektor, Karte und Kartenterminal als Seitenleiste wie im Dashboard
* Layout Anzeige Kartenterminal überarbeitet
...
* Kartenterminal: Kontext-Check, ob das Kartenterminal mit dem Default-Kontext des Konnektors von Cocard abgefragt werden kann. Falls nicht, erscheint eine Warnung in der Einzelanzeige des Kartenterminals.
...
* Neu: Hintergrundjob für die automatische PIN-Verifizierung (nur unterstützte Terminals). SMC-B Auto-PIN-Mode muss hierfür am Kartenterminal gleich `Automatisch` sein. xref:ct/card-terminal-edit.adoc[Mehr zur automatischen PIN-Verifizierung]
...
* Neu: xref:connector/connector-edit.adoc#_authentifikation_per_userpasswort[Client-Authentifikation am Konnektor mit User/Passwort] (alternativ zum Client-Zertifikat)
...
* xref:ct/smcb-remote-pin.adoc[Remote-SMC-B PIN Support für ORGA 6141 online]
