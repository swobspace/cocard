...
Viele Felder aus der allgemeinen Information sind bereits in xref:connector/connector-edit.adoc[] beschrieben. Weitere Felder werden aus den Konnektor-Informationen extrahiert:
...
Anzeige von Zugewiesenen Kontexten und Zertifikaten. Zur Pflege von Kontexten und Zertifikaten siehe xref:admin/contexts.adoc[] und xref:connector/connector-edit.adoc[]
