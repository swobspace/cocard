...
Die von der Gematik definierte SOAP-Schnittstelle in https://gemspec.gematik.de/docs/gemSpec/gemSpec_Kon/latest/[Gematik gemSpec_Kon] wird ergänzt durch den https://gemspec.gematik.de/docs/gemILF/gemILF_PS/latest/[Implementierungsleitfaden Primärsysteme] und ist sehr umfangreich. Das soll sicherstellen, dass einzelne Komponenten ausgetauscht werden können, ohne die Schnittstellen auf der Seite der Primärsysteme ändern zu müssen. Die Grundregeln dabei sind:
